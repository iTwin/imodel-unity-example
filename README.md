...
This example currently only works with [Snapshot iModels](https://imodeljs.github.io/iModelJs-docs-output/learning/backend/accessingimodels/).
Briefcases from [iModelHub](https://imodeljs.github.io/iModelJs-docs-output/learning/imodelhub/) would use the
same code but require an additional authorization step in order to acquire the briefcase. A demonstration of
this step will be included in a future version of this sample.
